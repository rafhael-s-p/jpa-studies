...
public class EcmSchemaMultiTenantConnectionProvider implements
    ...
    public Connection getConnection(String tenantIdentifier) throws SQLException {
        ...
        try {
            ...
            throw new HibernateException("Unable to change to schema " + tenantIdentifier + ".", e);
        }
    ...
    @Override
    public void start() {
        HikariCPConnectionProvider hikariCPConnectionProvider = new HikariCPConnectionProvider();
        hikariCPConnectionProvider.configure(this.properties);

        connectionProvider = hikariCPConnectionProvider;
    }
