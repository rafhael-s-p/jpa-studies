...
import com.studies.ecommerce.hibernate.TenantFilter;
...
public class SpringInitializeWeb implements WebApplicationInitializer {

    @Override
    public void onStartup(ServletContext servletContext) throws ServletException {
        AnnotationConfigWebApplicationContext applicationContext = new AnnotationConfigWebApplicationContext();

        applicationContext.scan(SpringInitializeWeb.class.getPackage().getName());
